...
public class FunctionsByGenre {
	
	public static boolean belong(double value, double lower, double upper) {
	...
	public static boolean belong2(double value, double lower, double upper){
        if (value >= lower && value < upper){
            return true;
        }
        else return false;
	...
	public static List<String> getSame(Big5Entity big, double value){
